...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Location = System::Drawing::Point(41, 51);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(548, 138);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(41, 245);
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(155, 22);
			this->textBox1->TabIndex = 2;
			this->textBox1->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &Lab3::textBox1_KeyPress);
			// 
			// textBox2
			// 
			...
			this->textBox2->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &Lab3::textBox2_KeyPress);
			// 
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(434, 245);
			this->textBox3->Name = L"textBox3";
			this->textBox3->Size = System::Drawing::Size(155, 22);
			this->textBox3->TabIndex = 4;
			this->textBox3->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &Lab3::textBox3_KeyPress);
			// 
			// label1
			// 
			this->label1->AutoSize = true;
			this->label1->Location = System::Drawing::Point(38, 226);
			...
			this->label2->Location = System::Drawing::Point(235, 226);
			...
			this->label3->Location = System::Drawing::Point(431, 226);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(86, 16);
			this->label3->TabIndex = 7;
			this->label3->Text = L"Значение b:";
			// 
			// button2
			// 
			this->button2->Location = System::Drawing::Point(238, 288);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(155, 23);
			this->button2->TabIndex = 8;
			this->button2->Text = L"OK";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &Lab3::button2_Click);
			// 
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(238, 341);
			...
			this->label4->Location = System::Drawing::Point(235, 322);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(84, 16);
			this->label4->TabIndex = 10;
			this->label4->Text = L"Значение z:";
			// 
			// Lab3
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(8, 16);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(637, 370);
...
#pragma endregion
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		y = LaboratoryDLL::Class1::Vvod(textBox2);
		b = LaboratoryDLL::Class1::Vvod(textBox3);
		// Вычисление значения z
		LaboratoryDLL::Class1::Function_Lab3(x, y, b, z);
		// Вывод значения z
		LaboratoryDLL::Class1::Vivod(z, textBox4);
	}
