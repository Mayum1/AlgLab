...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Сформируйте произвольный двумерный массиав L(m,m). Найдите в каждой строке\r\nнаибо"
				L"льший элемент и поменяйте его местами с элементом главной диагонали.";
			// 
			// listBox1
			// 
			...
			this->label3->Text = L"Полученная матрица";
			// 
			// label4
			// 
			...
			this->label4->Text = L"Размер исходной матрицы:";
			// 
			// label5
			// 
			...
			this->label5->Text = L"Число строк и столбцов m:";
			// 
			// textBox1
			// 
			...
			this->label6->Text = L"Диапазон случайных чисел:";
			// 
			// label7
			// 
			...
			this->label7->Text = L"Левая граница a:";
			// 
			// textBox2
			// 
			...
			this->label8->Text = L"Правая граница b:";
			// 
			// button2
			// 
...
#pragma endregion
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		listBox1->Items->Clear();	// Очистка списков
		listBox2->Items->Clear();
		int m, a, b;				// m - число строк и столбцов матрицы; a и b - диапазон случайных чисел
		if (!Lab7DLL::Class1::GetInt(m, textBox1, "Введите число строк/столбцов матрицы")) return;
		if (!Lab7DLL::Class1::GetInt(a, textBox2, "Введите левую границу диапазона")) return;
		if (!Lab7DLL::Class1::GetInt(b, textBox3, "Введите правую границу диапазона")) return;
		int** matr = Lab7DLL::Class1::input(m, a, b);	// Создание исходной матрицы
		Lab7DLL::Class1::output(matr, m, listBox1);		// Вывод исходной матрицы
		int** matr2 = Lab7DLL::Class1::task(matr, m);	// Создание новой матрицы
		Lab7DLL::Class1::output(matr2, m, listBox2);	// Вывод новой матрицы
	}
